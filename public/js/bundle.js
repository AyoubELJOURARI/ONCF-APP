...
}; //type soit error ou success (data.status)
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              window.setTimeout(function () {
                //in 1,5 second
                location.assign('/contracts', 1500);
              });
            }
